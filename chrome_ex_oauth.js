...
ChromeExOAuth.prototype.setReqToken = function(token) {
  localStorage["reqToken"] = token;
};
ChromeExOAuth.prototype.getReqToken = function() {
  return localStorage["reqToken"];
};
ChromeExOAuth.prototype.setBookmarkInfo = function(info) {
  localStorage["bookmarkInfo"] = info;
};
ChromeExOAuth.prototype.getBookmarkInfo = function() {
  return localStorage["bookmarkInfo"];
};
